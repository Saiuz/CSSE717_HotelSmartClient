...
public class UnderstandingDEMO extends Activity implements OnClickListener {
    private static String TAG = UnderstandingDEMO.class.getSimpleName();
    // 语义理解对象（语音到语义）。
...
//    private SharedPreferences mSharedPreferences;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.understanding_activity);
         ...
         */
        // 初始化对象
        mSpeechUnderstander = SpeechUnderstander.createUnderstander(UnderstandingDEMO.this, mSpeechUdrInitListener);
        mTextUnderstander = TextUnderstander.createTextUnderstander(UnderstandingDEMO.this, mTextUdrInitListener);

        mToast = Toast.makeText(UnderstandingDEMO.this, "", Toast.LENGTH_SHORT);
    }
    ...
    private void initLayout(){
        findViewById(R.id.Text_UDSD).setOnClickListener(UnderstandingDEMO.this);
        findViewById(R.id.Voice_UDSD).setOnClickListener(UnderstandingDEMO.this);

        mUnderstanderText = (EditText)findViewById(R.id.EditText_UDSD);

        findViewById(R.id.Stop_Record).setOnClickListener(UnderstandingDEMO.this);
        findViewById(R.id.Turn_Back).setOnClickListener(UnderstandingDEMO.this);
...
//                        showTip(getString(R.string.text_begin));
    ...
    private TextUnderstanderListener mTextUnderstanderListener = new TextUnderstanderListener() {
        ...
        public void onResult(final UnderstanderResult result) {
            if (null != result) {
                ...
                //// TODO: 2017/2/21 onResult方法的 String text = result.getResultString()就是最终的语义分析结果，需要进行JSON处理
            } else {
    ...
    private SpeechUnderstanderListener mSpeechUnderstanderListener = new SpeechUnderstanderListener() {
        ...
        public void onResult(final UnderstanderResult result) {
            if (null != result) {
                ...
                if (!TextUtils.isEmpty(text)) {
                    ...
                    //// TODO: 2017/2/26  parse json file   String text is the json result
                    parseJson(text);
        ...
        private void parseJson(String jsonString){
            ...
            try {
                //// TODO: 2017/2/26      check if  "rc" = 0 first
                ...
                if (jsonObject != null ){
                    if (jsonObject.optInt("rc", -1) == 0){
                        ...
                        //// TODO: 2017/2/26    all JSONObjects must use after checking it`s null or not
                            ...
                            if (attrValue.equals("开")){
                                ...
                                switch (location_room){
                                    case "浴室":
                                        ...
                                        //// TODO: 2017/2/26   send bluetooth message to control the light one
                                        break;
                                    case "客厅":
...
//        String lang = mSharedPreferences.getString("understander_language_preference", "mandarin");
    ...
    protected void onResume() {
        //移动数据统计分析
        FlowerCollector.onResume(UnderstandingDEMO.this);
    ...
    protected void onPause() {
        ...
        FlowerCollector.onPause(UnderstandingDEMO.this);
        super.onPause();
    }
